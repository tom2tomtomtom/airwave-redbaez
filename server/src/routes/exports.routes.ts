...
router.get('/platform-specs', checkAuth, async (req, res) => {
  try {
...
router.post('/campaign/:id', checkAuth, async (req, res) => {
  try {
...
router.get('/campaign/:id/status', checkAuth, async (req, res) => {
  try {
    const { id } = req.params; // Campaign ID
...
router.get('/campaign/:id/download', checkAuth, async (req, res) => {
  try {
    const { id } = req.params; // Campaign ID
...
router.post('/campaign/:id/schedule', checkAuth, async (req, res) => {
  try {
    const { id } = req.params; // Campaign ID
    const { 
      platform, 
