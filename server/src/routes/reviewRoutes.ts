...
router.post('/reviews', internalAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
...
router.get('/assets/:assetId/reviews', internalAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
...
router.get('/review/:token', reviewAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
...
router.post('/review/:token/comments', reviewAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
...
router.post('/review/:token/approve', reviewAuth, async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
